      ...
      <div className="relative z-10">
        ...
        >
          <motion.div variants={fadeInUp}>
            <Badge
              variant="outline"
              className="px-3 py-1 text-sm font-medium border-primary/20 bg-primary/5 text-primary rounded-full"
            >
          ...
          >
            ...
            <Link to="/courses">
              <Button
                variant="outline"
                size="lg"
                className="w-full sm:w-auto text-base px-8 h-11 rounded-md bg-background hover:bg-accent/50"
              >
