...
public class GatewayHeaderAuthenticationHandlerTests
{
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldReturnNoResult_WhenUserIdHeaderIsMissing()
    {
        // Arrange
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldReturnFailure_WhenUserIdHeaderIsEmpty()
    {
        // Arrange
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldSucceed_WithValidUserId()
    {
        // Arrange
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldAddSingleRole_WhenSingleRoleHeaderProvided()
    {
        // Arrange
        _context.Request.Headers[HeaderNames.UserIdHeader] = "user123";
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldAddMultipleRoles_WhenMultipleRoleHeadersProvided()
    {
        // Arrange
        _context.Request.Headers[HeaderNames.UserIdHeader] = "user123";
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldIgnoreEmptyRoles()
    {
        // Arrange
        _context.Request.Headers[HeaderNames.UserIdHeader] = "user123";
        _context.Request.Headers.Append(HeaderNames.UserRoleHeader, "Admin");
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldAddValidPermissions()
    {
        // Arrange
        _context.Request.Headers[HeaderNames.UserIdHeader] = "user123";
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldIgnoreInvalidPermissions()
    {
        // Arrange
        _context.Request.Headers[HeaderNames.UserIdHeader] = "user123";
        _context.Request.Headers.Append(HeaderNames.UserPermissionsHeader, "allow:read:course:123");
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldIgnoreEmptyPermissions()
    {
        // Arrange
        _context.Request.Headers[HeaderNames.UserIdHeader] = "user123";
        _context.Request.Headers.Append(HeaderNames.UserPermissionsHeader, "allow:read:course:123");
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldSucceedWithoutRolesOrPermissions()
    {
        // Arrange
        _context.Request.Headers[HeaderNames.UserIdHeader] = "user123";
        var handler = CreateHandler();
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldHandleNullRoleValues()
    {
        // Arrange
        _context.Request.Headers[HeaderNames.UserIdHeader] = "user123";
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldHandleNullPermissionValues()
    {
        // Arrange
        _context.Request.Headers[HeaderNames.UserIdHeader] = "user123";
    ...
    [Fact]
    public async Task HandleAuthenticateAsync_ShouldCreateCorrectAuthenticationTicket()
    {
        // Arrange
        _context.Request.Headers[HeaderNames.UserIdHeader] = "user123";
        _context.Request.Headers[HeaderNames.UserRoleHeader] = "Admin";
